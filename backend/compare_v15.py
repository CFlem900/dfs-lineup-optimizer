...
data = json.load(open("v15_lineups.json", encoding="utf-8"))
print(f"=== v15 vs New DK Sims ===")
...
if n_dk > 0:
    ...
    total_delta = 0
    count = 0
    for name, our_pct, dk_pct, delta in comparison[:40]:
...
if dk_hub:
    ...
    deltas = []
    for name, cnt in our_exposure.most_common(40):
...
if deltas:
    ...
    print(f"  Within 30% of DK:   {within_30:.0f}%")
